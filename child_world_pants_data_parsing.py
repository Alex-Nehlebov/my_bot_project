...
def url_get():
    ...
    try:
        ...
        while True:
            ...
            page_url = f'https://detmir.by/catalog/index/name/diapers_pants/page/{page}/'
...
def child_world_pants_data_parsing():
    ...
    try:
        ...
        for card_url_info in url_get():
            ...
            with sq.connect('child_world_pants.db') as con:
                ...
                cur.execute("""CREATE TABLE IF NOT EXISTS diaper_pants_child_world(
                ...
                cur.execute(
                    f"""INSERT INTO diaper_pants_child_world (brand_name, name, size, actual_price, old_price, 
                    store_name) VALUES(?, ?, ?, ?, ?, ?)""",
                    (brand_name, name, size_for_sql, actual_price, old_price, store_name))
                cur.execute("SELECT * FROM diaper_pants_child_world")
                result = cur.fetchall()
        for i in result:
            print(
...
child_world_pants_data_parsing()
